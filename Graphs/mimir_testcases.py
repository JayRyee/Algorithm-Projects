...
class GraphTests(unittest.TestCase):
    ...
    def test_12_construct_matrix_from_graph(self):
    ...
    def test_20_a_star_msu(self):
        ...
        vertices = [Vertex('A', 0, 0), Vertex('B', 2, 0), Vertex('C', 4, 0), Vertex('D', 6, 0), Vertex('E', 9, 0),
                    ...
                    Vertex('Spartan Stadium', 4, 2), Vertex('Wells Hall', 9, 2), Vertex('Engineering Building', 9, -2),
        ...
        edges = [('A', 'B', 8), ('B', 'C', 8), ('C', 'D', 8), ('D', 'E', 12), ('E', 'F', 12), ('B', 'G', 5),
                 ('D', 'H', 4), ('F', 'I', 16),
                 ('G', 'H', 5), ('H', 'I', 6), ('G', 'J', 5), ('I', 'L', 16), ('J', 'K', 4), ('K', 'L', 4),
                 ('J', 'M', 4), ('M', 'L', 4),
